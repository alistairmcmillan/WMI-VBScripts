...
Dim strComputer, strFilename, objFileSystem, objFile, objFSO, _
	objFolder, objSubFolders, objSubFolder, queriesFolder
...
For Each objSubFolder in objSubFolders
	If objFSO.FolderExists("\\" & strComputer & "\c$\documents and settings\" & objSubFolder.name & "\application data\microsoft\queries") Then
		Set queriesFolder = objFSO.GetFolder("\\" & strComputer & "\c$\documents and settings\" & objSubFolder.name & "\application data\microsoft\queries")
